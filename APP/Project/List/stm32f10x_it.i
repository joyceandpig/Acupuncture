...
#line 32 "stm32f10x_it.h"

 
 
 
 
extern volatile uint32_t TIMx_timecount,TIMy_timecount,TIMz_timecount;
...
#line 29 "stm32f10x_it.c"
#line 30 "stm32f10x_it.c"
#line 31 "stm32f10x_it.c"



static uint8_t ch_count = 0;  
volatile uint32_t TIM2_timecount = 0,
				 TIM3_timecount = 0,
				 TIM4_timecount = 0;
...
void TIM2_IRQHandler(void)
{
 	...
 	if (TIM_GetITStatus(((TIM_TypeDef *) (((uint32_t)0x40000000) + 0x0000)),((uint16_t)0x0001)) != RESET)
	{
		...
		TIM2_timecount++;
		if (TIM2_timecount > 50000)		          
		{
			TIM2_timecount = 0;                    
			for (ch_count = 0; ch_count < 6; ch_count++)
			{
...
void TIM3_IRQHandler(void)
{
    ...
    TIM3_timecount++;
      ...
      if (report_time5s > 0)  
			{
				report_time5s = 0;
        state_report_flag = TRUE;	         
			}
			
			heart_time_count++;
      if(heart_time_count > 5) 
      {
        heart_time_count = 0;
				if (system_start)
				{
	...
	if (RepPar.time_start) 
	{
		 RepPar.time_count++;
		 if (RepPar.time_count > 5000) 
		 {
	...
	if (ErrPar.time_start) 
	{
		 ErrPar.time_count++;

		 if (ErrPar.time_count > 5000) 
		 {
  ...
  if (ImpPar.time_start)  
  {
    ImpPar.time_count++;
    if (ImpPar.time_count > 1000)
    {
...
{	
if (USART_GetITStatus(((USART_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x3800)),((uint16_t)0x0525)) != RESET)
{
	EnQueue(&Queue,USART_ReceiveData(((USART_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x3800))));           	 
	USART_ClearITPendingBit(((USART_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x3800)),((uint16_t)0x0525)); 
	TIM_Cmd(((TIM_TypeDef *) (((uint32_t)0x40000000) + 0x0800)),DISABLE);
	TIM_SetCounter(((TIM_TypeDef *) (((uint32_t)0x40000000) + 0x0800)),0);
