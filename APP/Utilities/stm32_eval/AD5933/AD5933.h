...
typedef struct 
{
	signed short collect_val_real;
	signed short collect_val_imag;
}_FeedBack;
typedef struct 
{
...
{
  Channel_1 = 0x01,                                 // 51R
  Channel_2 = 0x02,                                 // 100R  1
  Channel_3 = 0x04,                                 // 1K   2
  Channel_4 = 0x08,                                 // 10K  3
  Channel_5 = 0x10,                                 // 47K
  Channel_6 = 0x20,                                 // 100K  4
  Channel_7 = 0x40,                                 // 1M   5
  Channel_8 = 0x80                                  // 4M
} ChannelType;

extern void SendCmdReply(uint8_t *Sdata, uint8_t Slength);
void AD5933_Init(void);                 				    //初始化
extern void AD5933_Para_Init(void);
...
extern void ImpVal(uint16_t Ifunc_code,uint8_t *Idata);
